  ...
  <q-card-section class="row">
    ...
    @submit="onSubmit()"
        ...
        <q-input
            ...
            label="Judul Film"
            lazy-rules
            :rules="[ val => val && val.length > 0 || 'Input Judul Film']"
        />
          <q-input
          filled
          v-model="form.harga"
          ...
          type="number"
          lazy-rules
          :rules="[ val => val && val.length > 0 || 'Input Harga']"
        />
        <q-input
          filled
          v-model="form.tahun"
          label="Tahun Film"
          lazy-rules
          :rules="[ val => val && val.length > 0 || 'Input Tahun']"
        />
        <q-select
          filled
          v-model="form.genre"
          :options="optionGenre"
          label="Pilih Genre"
          :rules="[ val => val && val.length > 0 || 'Input Genre']"
        />
        <div class="flex">
          Pilih Rating
          <q-rating
        ...
        <q-input
          ...
          type="textarea"
          label="Deskripsi"
          :rules="[ val => val && val.length > 0 || 'Input Deskripsi']"
        />
